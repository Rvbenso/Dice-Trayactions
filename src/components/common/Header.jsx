...
export default function Header() {
    return (
        <head className="text-[200%] z-2 absolute rounded-full w-[98%] h-[200px] m-[20px] bg-linear-to-r from-[#00ccff] to-[#ff00dd] bg-opacity-50 items-center justify-center flex">
